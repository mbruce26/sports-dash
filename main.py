...
def main():
    ...
    # current game
    boxscore = [game for game in games["scoreboard"]["games"] if game["homeTeam"]["teamTricode"] == teamTricode or game["awayTeam"]["teamTricode"] == teamTricode]
    
    if len(boxscore) > 0:

        game_data = boxscore[0]
